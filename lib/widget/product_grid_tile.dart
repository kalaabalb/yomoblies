...
class ProductGridTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Constrain card width for desktop layouts to prevent stretching
      ...
      child: CustomCard(
        ...
        child: Column(
          ...
          children: [
            ...
            // Product Name - wrapped in Flexible for overflow safety
            Flexible(
              child: Text(
            ...
            // Price Row - ensure Flexible wraps each text for narrow screens
            Row(
              children: [
                Flexible(
                  child: Text(
